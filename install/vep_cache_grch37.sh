...
# When VEP_ENSEMBL_VERSION is a major version (e.g. 107.0) the cache path generated by
# VEP uses the truncated version number (without the ".0" decimal part)
VEP_ENSEMBL_VERSION_CACHE=${VEP_ENSEMBL_VERSION}
SUB_VERSION=${VEP_ENSEMBL_VERSION: -2}
if [ ${SUB_VERSION} == ".0" ]; then VEP_ENSEMBL_VERSION_CACHE=${VEP_ENSEMBL_VERSION_CACHE%.*}; fi
CACHE_PATH=${VEP_CACHE_DIR}/${SPECIES}/${VEP_ENSEMBL_VERSION_CACHE}_${ASSEMBLY}
